...
public class StockController {
	...
	@RequestMapping(value = "/componyStock", method = RequestMethod.GET)
	public ModelAndView getComponyStock(String comName) {
		...
		ComponyHistoryYear historyYear =  service.getYearHistory(comName);

		List<Compony> cList = new ArrayList<Compony>();
		//List<ComponyHistoryYear> yhistory = new ArrayList<ComponyHistoryYear>();
		cList.add(compony);
